...
# Что нужно сделать
# После различных вопросов про различия итераторов, 
# генераторов и генераторных выражений 
# на собеседовании вам дали небольшой пример кода и попросили «провести рефакторинг». 
# Вот сам код:
