...
# Решение оформите в виде функции move (n, x, y), 
# которая печатает последовательность перекладываний дисков для перемещения пирамидки высотой N со стержня номер X на стержень номер Y.
...
# Совет: для начала определите номер промежуточного колышка. 
# Для этого подумайте о сумме трёх чисел колышка. 